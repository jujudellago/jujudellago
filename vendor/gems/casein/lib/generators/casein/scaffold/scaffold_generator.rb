module Casein
  class ScaffoldGenerator < Rails::Generators::NamedBase
    ...
    def generate_files
      ...
      template 'views/index.js.erb', "app/views/casein/#{plural_name}/index.js.erb"
      template 'views/enabledisable.js.erb', "app/views/casein/#{plural_name}/enabledisable.js.erb"
      ...
      template 'views/_object_form.html.erb', "app/views/casein/#{plural_name}/_#{singular_name}_form.html.erb"
      template 'views/_objects.html.erb', "app/views/casein/#{plural_name}/_#{plural_name}.html.erb"
      template 'views/_object.html.erb', "app/views/casein/#{plural_name}/_#{singular_name}.html.erb"
  ...
  protected
    ...
    def add_to_routes
      ...
      file_to_update = Rails.root + 'config/routes.rb'
      line_to_add = "resources :#{plural_name} do \n\t\t\tmember do \n\t\t\t\t\t put 'enabledisable'\n\t\t\tend\n\t  end"
    ...
    def add_to_navigation
      ...
      file_to_update = Rails.root + 'app/views/layouts/_top_navigation.html.erb'
